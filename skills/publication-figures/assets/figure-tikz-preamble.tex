...
%
% The colors are the same Okabe-Ito values as figure_style.PALETTE, so a
...
\definecolor{figureblue}{HTML}{0072B2}
\definecolor{figureorange}{HTML}{E69F00}
\definecolor{figuregreen}{HTML}{009E73}
\definecolor{figurered}{HTML}{D55E00}
\definecolor{figurepurple}{HTML}{CC79A7}
...
\tikzset{
  ...
  ours/.style={block, draw=figureblue, fill=figureblue!7, line width=0.7pt},
  ...
  backflow/.style={->, draw=figureorange, dashed},
